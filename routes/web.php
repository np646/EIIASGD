...
Route::middleware(['auth:sanctum', 'role:admin,titulacion,practicas,asistente'])->group(function () {
...
Route::middleware(['auth:sanctum', 'role:admin,titulacion,asistente'])->group(function () {
...
Route::middleware(['auth:sanctum', 'role:admin,titulacion,practicas'])->group(function () {
...
Route::middleware(['auth:sanctum', 'role:admin,practicas'])->group(function () {
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::prefix('api/reportes')->group(function () {
        ...
        Route::get('/titulacion/estado-proceso/{id}', [GraduationController::class, 'getProcessStatus'])->name('api.graduation.getProcessStatus');
        Route::get('/vinculacion/estado-proceso/{id}', [CommunityController::class, 'getProcessStatus'])->name('api.community.getProcessStatus');
        ...
        Route::get('/preprofesionales/estado-proceso/{id}', [PreprofessionalController::class, 'getProcessStatus'])->name('api.preprofessional.getProcessStatus');
