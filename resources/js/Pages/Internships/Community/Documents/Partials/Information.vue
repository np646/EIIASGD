<template>
    <ContentContainer>
        <Subtitle title="Información del estudiante" />
        <div class="pl-5 py-3">
            <div class="row h-[8rem]">
                <div class="col-2 d-flex flex-column justify-content-center">
                    <div class="row h-full">
                        <div class="col d-flex justify-content-center align-items-center">
                            <BIconPersonFill class="student-avatar" />
                        </div>
                    </div>
                </div>
                <div class="col-10 d-flex flex-column justify-content-center">
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="row mb-2">
                                <span class="fs-6">{{ student.original.course_name }}</span>
                            </div>
                            <div class="row">
                                <ButtonGroup>
                                    <Button label="Ir a perfil" icon="pi pi-user" size="small" @click="visitProfile"></Button>
                                    <Button label="Ir a proceso de prácticas de vinculación" icon="pi pi-graduation-cap" size="small" @click="visitProcess"></Button>
                                </ButtonGroup>
                            </div>
                        </div>
                    </div>
...
function visitProcess() {
    const url = route('community.process', { student: student.original.id});
    router.visit(url);
}
