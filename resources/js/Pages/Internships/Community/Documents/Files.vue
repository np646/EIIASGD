<template>
    <Head title="Documentos de prácticas de vinculación" />
    <MenuLayout>
        <Information />
        <ContentContainer>
...
const openUpdateDialog = (id) => {
    ...
    form.community_files_id = id;
};

const uploadFile = () => {
    form.post(
        route("community.storeFile", {
            parentId: 2,
        }),
        {
            onSuccess: () => {
...
const deleteFile = async () => {
    ...
    const url = route("files.destroyCommunity", {
